...
C_DEPS += \
./Src/Middleware/lvgl/src/widgets/list/lv_list.d 


# Each subdirectory must supply rules for building sources it contributes
Src/Middleware/lvgl/src/widgets/list/%.o Src/Middleware/lvgl/src/widgets/list/%.su: ../Src/Middleware/lvgl/src/widgets/list/%.c Src/Middleware/lvgl/src/widgets/list/subdir.mk
...
clean: clean-Src-2f-Middleware-2f-lvgl-2f-src-2f-widgets-2f-list

clean-Src-2f-Middleware-2f-lvgl-2f-src-2f-widgets-2f-list:
	-$(RM) ./Src/Middleware/lvgl/src/widgets/list/lv_list.d ./Src/Middleware/lvgl/src/widgets/list/lv_list.o ./Src/Middleware/lvgl/src/widgets/list/lv_list.su

.PHONY: clean-Src-2f-Middleware-2f-lvgl-2f-src-2f-widgets-2f-list
